...
============QuanX============
[rewrite_local]
^https:\/\/api\.pingmeapp\.net\/app\/queryBalanceAndBonus url script-request-header https://raw.githubusercontent.com/oo226/egern-config/refs/heads/surge/Scripts/PingMe-capture.js

[task_local]
30 8,20 * * * https://raw.githubusercontent.com/oo226/egern-config/refs/heads/surge/Scripts/PingMe-signin.js, img-url=https://raw.githubusercontent.com/fmz200/wool_scripts/main/icons/apps/PingMe.png, tag=PingMe签到, enabled=true
...
async function startTasks() {
    ...
    const raw = isNode ? process.env[ckKey] : ($.getdata(ckKey) || $.getdata('#' + ckKey));
    if (!raw) {
